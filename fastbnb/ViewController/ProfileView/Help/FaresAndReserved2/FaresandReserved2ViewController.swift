//
//  FaresandReservedViewController.swift
//  fastbnb
//
...
class FaresandReserved2ViewController: UIViewController {
    ...
    let data = FaresandReserved2Data()
}

extension FaresandReserved2ViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.data.list.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! FaresandReserved2Cell
